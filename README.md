...
6. If you did everything correct, https://joindewalvis.github.io/TestApi/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://joindewalvis.github.io/TestApi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://joindewalvis.github.io/TestApi/ with url from the message: `Server started <url>`
